...
?>
	...
	<input type="hidden" name="cmd" value="_xclick" />
        ...
        <input type="image" src="images/button.jpg" border="0" name="submit" alt="Make payments with UPI - it's fast, free and secure!"  />
        <img alt="fdff" border="0" src="#" width="1" height="1" />
		</div>
        <!-- Payment confirmed -->
